...
final class CloudPreferencesTab: NSView {
    ...
    func loadSettings() {
        let settings = preferences.cloudFallbackSettings
    ...
    private func updateKeyStatus() {
        if preferences.hasAPIKey(.openAI) {
    ...
    @objc private func cloudFallbackChanged() {
        var settings = preferences.cloudFallbackSettings
        settings.enabled = cloudFallbackToggle.state == .on
        preferences.cloudFallbackSettings = settings
    }
    ...
    @objc private func openAIKeyChanged() {
        ...
        preferences.setAPIKey(key, type: .openAI)
    ...
    @objc private func groqKeyChanged() {
        ...
        preferences.setAPIKey(key, type: .groq)

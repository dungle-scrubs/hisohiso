...
final class ModelPreferencesTab: NSView {
    ...
    init(modelManager: ModelManager, modelSelectionController: ModelSelectionController) {
    ...
    func loadSettings() {
        ...
        fillerWordsField.stringValue = preferences.fillerWords.joined(separator: ", ")
        updateModelUI()
    }

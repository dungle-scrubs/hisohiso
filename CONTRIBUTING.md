...
Pull requests run the Swift quality gate in GitHub Actions. Run the
...
The release workflow runs the same Swift checks before release-please can
prepare release pull requests or tags. `make validate` also verifies that
all concurrency escape hatches are listed in
